...
Execute::Execute()
{
	...
	*/
	...
	//정점 정보가 바뀌면 INPUT LAYOUT정보도 바뀐다.
	...
	//Create World View Projection
	{
		...
		*/
		...
		//World
		D3DXMATRIX S; //크기를 늘려주겠다 // 500이 최대임 세팅스에서 설정함
	...
	{
		//넘어온 이미지가 있어야하지, 그림 파일아무거나 가져와
		//FileA 는 A는 아스키코드고 W는 widechar형이인다
		//원본을 안써도 된다.
