...
void AnimationDemo::Kachujin()
{
	...
	for (UINT i = 0; i < count; i++)
	{
		...
		colliderObject[i]->Collider = new Collider(colliderObject->Transform, colliderInitTransform)
	}
