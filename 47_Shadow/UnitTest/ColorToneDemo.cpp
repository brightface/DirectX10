...
void ColorToneDemo::Initialize()
{
	...
	renderTarget = new RenderTarget((UINT)width, (UINT)height, DXGI_FORMAT_R32G32B32A32_FLOAT);
	...
	postEffect = new PostEffect(L"40_ColorTone.fxo");
...
void ColorToneDemo::AddBillboard()
{
