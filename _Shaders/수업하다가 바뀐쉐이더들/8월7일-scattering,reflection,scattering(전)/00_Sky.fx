...
///////////////////////////////////////////////////////////////////
static const float EarthInnerRadius = 6356.7523142f; //지구의 둘레
static const float EarthOuterRadius = 6356.7523142f * 1.0157313f; //적도부분이지. 중력에 의해 회전
...
static const float2 RayleighMieScaleHeight = { 0.25f, 0.1f };//높이 - 레일리 어느부분에서 시작될지
static const float EarthScale = 1.0 / (6356.7523142 * 1.0157313 - 6356.7523142);
//적도부분

static const float SunExposure = -2.0f; //태양의 강도

static const float FloatOne = 0.00390625; //로그4
...
//vertexTexture : ndc 공간사용할려고 만든거고
...
PixelOutput_Scattering PS_Scattering(VertexOutput_Scattering input)
{
    ...
    //빛이 닿는 공간 구하려고 (카메라가 도착까지 수평으로 닿는부분)
...
VertexOutput_Moon VS_Moon(VertexTexture input)
{
    ...
    //output.Position = mul(output.Position, MoonProjection);
    output.Uv = input.Uv;

    return output;
}

//VertexOutput_Moon VS_Reflection_Moon(VertexTexture input)
//{
//    VertexOutput_Moon output;
...
//풀을 랜덤으로 깔때 
//풀을 일정하게 있으면 풀 이 구간 있으면 사각형 있음녀 컬링 이 넘치고 텍스처 하나 만들어가지고 
///////////////////////////////////////////////////////////////////////////////
// Draw Cloud
///////////////////////////////////////////////////////////////////////////////
cbuffer CB_Cloud
...
//VertexOutput_Cloud VS_Reflection_Cloud(VertexTexture input)
//{
//    VertexOutput_Cloud output;
...
//컬링 노이즈 결과야 .fps면 위로 올라가서 보면 땅이 구름에 묻이겠지. 외곽에다 안개를 주면 좀더 부드럽게는 나와. 
