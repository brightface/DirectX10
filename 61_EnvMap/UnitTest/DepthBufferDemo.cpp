...
void DepthBufferDemo::Initialize()
{
	Context::Get()->GetCamera()->RotationDegree(20, 0, 0);
	Context::Get()->GetCamera()->Position(1, 36, -85);


	shader = new Shader(L"48_DepthBuffer.fxo");
...
void DepthBufferDemo::PostRender()
{
	render2D->Render();
}
...
void DepthBufferDemo::Pass(UINT mesh, UINT model, UINT anim)
{
